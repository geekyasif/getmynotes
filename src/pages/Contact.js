        ...
        <div className="container px-5 py-24 mx-auto ">
          <div className="flex flex-col text-center w-full mb-12 ">
            ...
            <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
              We're Here to Help
              <br />
              Contact Us for Any Queries or Support with Our University Notes
            ...
            <div className="flex flex-wrap -m-2">
              ...
              <div className="p-2 w-full">
                <button
                  ...
                  className={
                    loading
                      ? "flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg disabled:opacity-50 disabled:cursor-not-allowed"
